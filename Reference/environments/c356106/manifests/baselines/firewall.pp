# Class: c356106::firewall
#
# Maintains custom firewall rules for all hosts defined in environment c356106.
#
# Operating systems:
#	:Working
#
...
class c356106::firewall() {
	...
	class pci() {
		...
		# Puppet Development Rules
		@firewall { '300 Ariel Development TCP Outgoing':
      proto => 'tcp',
      dport => '8150',
      chain => 'OUTPUT',
      action => 'accept',
    ...
    @firewall { '300 Ariel Development TCP Incoming':
      proto => 'tcp',
      sport => '8150',
      chain => 'INPUT',
      action => 'accept',
      state   => ['RELATED', 'ESTABLISHED'],
		...
		# WEB Rules  
    @firewall { '300 HTTP TCP Outgoing':
      proto => 'tcp',
      dport => '80',
      chain => 'OUTPUT',
      action => 'accept',
    ...
    @firewall { '300 HTTP TCP Incoming':
      proto => 'tcp',
      sport => '80',
      chain => 'INPUT',
      action => 'accept',
    ...
    @firewall { '300 HTTPS TCP Outgoing':
      proto => 'tcp',
      dport => '443',
      chain => 'OUTPUT',
      action => 'accept',
    ...
    @firewall { '300 HTTPS TCP Incoming':
      proto => 'tcp',
      sport => '443',
      chain => 'INPUT',
      action => 'accept',
