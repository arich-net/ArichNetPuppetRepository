node 'evl0300496.eu.verio.net' {
  ...
  $aclarray = {
    ...
    6 => { 'name' => 'localnet', 'type' => 'src', 'setting' => '172.24.0.0/12' },
    ...
    27 => {'name'    => 'windowsupdate','type'    => 'dstdomain', 'setting' => 'ctldl.windowsupdate.com', } ,
    28 => {'name'    => 'windowsupdate','type'    => 'dstdomain', 'setting' => 'ds.download.windowsupdate.com', } ,
    29 => {'name'    => 'windowsupdate','type'    => 'dstdomain', 'setting' => 'mscrl.microsoft.com', } ,
    30 => {'name'    => 'windowsupdate','type'    => 'dstdomain', 'setting' => 'v4.download.windowsupdate.com', } ,
    31 => {'name'    => 'windowsupdate','type'    => 'dstdomain', 'setting' => 'www.msftncsi.com', } ,
    32 => {'name'    => 'windowsupdate','type'    => 'dstdomain', 'setting' => 'fg.ds.download.windowsupdate.com', } ,
    33 => {'name'    => 'redhatupdate','type'    => 'dstdomain', 'setting' => 'rhn.enterprise.verio.net', } ,
    34 => {'name'    => 'ubuntuupdate ','type'    => 'dstdomain', 'setting' => 'us.archive.ubuntu.com', } ,
    35 => {'name'    => 'ubuntuupdate ','type'    => 'dstdomain', 'setting' => 'security.ubuntu.com', } ,
    36 => {'name'    => 'webdav-frankfurt','type'    => 'dstdomain', 'setting' => 'webdav-frankfurt.eu.verio.net', } ,
    37 => {'name'    => 'kms-server','type'    => 'dstdomain', 'setting' => 'evw0300522.eu.verio.net', } ,
    38 => {'name'    => 'CONNECT','type'    => 'method', 'setting' => 'CONNECT', } ,
    39 => {'name'    => 'password','type'    => 'proxy_auth', 'setting' => 'REQUIRED', } ,
  }
  ...
  $httparray = {
    ...
    11 => { 'policy' => 'allow', 'acl1'   => 'webdav-frankfurt', 'acl2'   => '', 'acl3' => '' },
  ...
  #
    ...
    #
    class { 'postfix':
      postfix_myhostname => "evl0300496.eu.verio.net",
